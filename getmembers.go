...
// 解散群接口
type OpenimTribeGetmembersRequest struct {
	User    *OpenImUser `json:"user"`
	TribeId int         `json:"tribe_id"`
}

func (tribe *OpenimTribeGetmembersRequest) getApiMethodName() string {
	return `taobao.openim.tribe.getmembers`
}

func (tribe *OpenimTribeGetmembersRequest) check() (bool, error) {
...
func (tribe *OpenimTribeGetmembersRequest) getApiParas() (map[string]string, error) {
